...
[![Real Refuel Image][refuel_im]](https://example.com)
[![Simulated Refue Image][sim_im]](https://example.com)
...
2. Clone the repo
   ```sh
   git clone https://github.com/IsaacGreenMachine/C5AerialRefueling.git
   ```
...
See the [open issues](https://github.com/IsaacGreenMachine/C5AerialRefueling/issues) for a full list of proposed features (and known issues).
